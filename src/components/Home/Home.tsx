        ...
        <section className={styles.section} id='home'>
            <div className={styles['section__inner']}>
                <div className={styles['section__text-content']} data-aos="fade-up">
                    ...
                    <p className={styles['section__description']}>Приветствую! Я фронтенд разработчик и могу сделать для вас классные программистские штуки! Листайте вниз, что-бы узнать больше.</p>
                </div>
